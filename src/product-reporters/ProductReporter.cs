...
public abstract class ProductReporter
{
    ...
    public virtual void Subscribe(Product product)
    {
    ...
    protected virtual string GetSingleReport(Product product)
    {
    ...
    public abstract void ReportSingle(Product product);
